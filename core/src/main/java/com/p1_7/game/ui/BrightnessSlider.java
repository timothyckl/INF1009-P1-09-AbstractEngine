 ...
 * Value range is [Settings.MIN_BRIGHTNESS_LEVEL, 1.0]
...
public final class BrightnessSlider extends Slider {
     ...
     * @param initialValue starting brightness level in
     *        [Settings.MIN_BRIGHTNESS_LEVEL, 1.0]
     */
    ...
    protected float getMinValue() {
        return Settings.MIN_BRIGHTNESS_LEVEL;
    }
    ...
    @Override
    protected Color getTrackColour() {
        return COLOUR_TRACK;
    }

    @Override
    protected Color getFilledColour() {
        return COLOUR_FILLED;
    }

    @Override
    protected Color getKnobColour() {
        return COLOUR_KNOB;
    }

    @Override
    protected Color getKnobDragColour() {
        return COLOUR_KNOB_DRAG;
    }
}